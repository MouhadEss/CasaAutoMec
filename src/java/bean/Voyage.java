...
public class Voyage implements Serializable {
    ...
    public String toString() {
        return "Voyage{" + "id=" + id + ", model=" + model + ", nbrPlaceMax=" + nbrPlaceMax + ", prix=" + prix + ", nbrPlaceOuccuper=" + nbrPlaceOuccuper + ", personne=" + personne + ", villeDepart=" + villeDepart + ", villeArriver=" + villeArriver + ", dateVoyage=" + dateVoyage + ", circuitVoyages=" + circuitVoyages + '}';
    }
