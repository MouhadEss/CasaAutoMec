...
public class ManagerController implements Serializable {
    ...
    public void init() {
        ...
        //Shared coordinates
        LatLng coord1 = new LatLng(33.618933, -7.495624);
          
        //Basic marker
        simpleModel.addOverlay(new Marker(coord1, "Casa AutoMec"));
       }
    ...
    public String loginAdmin() {
        int i = ejbFacade.verifAdmin(selected.getIdAdmin(),selected.getPassword());
        if (i == 1) {
            System.out.println("hanadkhalt");
            return "/faces/admin_template?faces-redirect=true.xhtml";
        } else {
